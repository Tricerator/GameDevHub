...
class GameView(arcade.View):
    ...
    def on_draw(self):
        ...
        arcade.draw_text("vol  " + str(int(self.user_volume * 100)) + "%", 690, 575, arcade.csscolor.BLACK, 18, )
        arcade.draw_text("mus " + str(int(self.music_volume * 100)) + "%", 690, 550, arcade.csscolor.BLACK, 18, )
